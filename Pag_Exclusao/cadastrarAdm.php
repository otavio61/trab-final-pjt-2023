...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">SISTEMA DE GERENCIAMENTO DE USUÁRIO MUSEU PAULO AGOSTINHO</a>
            ...
            <div class="wrap-login100">
                <form method="post" class="login100-form validate-form" enctype="multipart/form-data">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "É preciso um nick valido">
                        <input class="input100" type="text" name="nick" minlength="10" placeholder="Nick para visualizção" required>
                        <span class="focus-input100"></span>
                    </div>
